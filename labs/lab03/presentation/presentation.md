...
![Вывод команды ipconfig](image/1.png){ width=80% }
...
![Проверка доступности шлюза по умолчанию](image/2.png){ width=80% }
...
![ICMP эхо-запрос в Wireshark](image/3.png){ width=80% }
...
![ICMP эхо-ответ в Wireshark](image/4.png){ width=80% }
...
![ARP-запрос и ARP-ответ](image/5.png){ width=80% }
...
![Ping доменного имени yandex.ru](image/6.png){ width=80% }
...
![Анализ пакетов при обращении к внешнему ресурсу](image/7.png){ width=80% }
...
![Детальный анализ ICMP пакета](image/8.png){ width=80% }
...
![HTTP-запрос и параметры TCP (порт 80)](image/9.png){ width=80% }
...
![HTTP-ответ и параметры TCP (порт 80)](image/10.png){ width=80% }
...
![DNS-запрос и параметры UDP (порт 53)](image/11.png){ width=80% }
...
![DNS-ответ и параметры UDP](image/12.png){ width=80% }
...
![QUIC Initial: параметры заголовка и Connection ID](image/13.png){ width=80% }
...
![QUIC Initial: ответный пакет и Source Connection ID](image/14.png){ width=80% }
...
![Общий список TCP-пакетов и выбранный поток](image/15.png){ width=80% }
...
![TCP SYN от клиента](image/16.png){ width=80% }
...
![TCP ACK — завершение handshake](image/17.png){ width=80% }
...
![График потока TCP в Wireshark](image/18.png){ width=80% }
